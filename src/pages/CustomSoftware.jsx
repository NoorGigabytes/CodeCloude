  ...
  return (
    ...
    <section className='container mx-auto max-w-screen-2xl px-6 pb-16 pt-20' id='section'>
      <div className='flex flex-wrap justify-between items-center'>
        <h1 className='lg:text-6xl text-4xl font-semibold'>Custom Software Development</h1>
      ...
      <h1 className='lg:text-4xl text-2xl font-semibold pt-16 md:pb-16 pb-8'>High Quality Software Development Services at Affordable Price</h1>
        <img src='../assets/img/custom-solutions-intro-img.jpg' alt='custom solutions intro image'/>
    </section>
    ...
    <section className='container mx-auto max-w-screen-2xl px-6 pt-20' id='section'>
        <h1 className='lg:text-4xl text-2xl font-semibold border-b-2 pb-4 mb-10 mx-auto md:w-max'>Advanced Technologies for Custom Software Solutions</h1>
        <div className='grid lg:grid-cols-2 grid-cols-1 gap-4 '>
            <img src='../assets/img/platform-expertise.jpg' alt='platform enterprise image' className='mx-auto mt-auto'/>
    ...
    <section className='container mx-auto max-w-screen-2xl md:px-20 px-5 py-20 bg-zinc-100' id='section'>
        <h1 className='lg:text-4xl text-2xl font-semibold border-b-2 pb-4 mb-10 mx-auto md:w-max'>Perks of having a Custom Software</h1>
    ...
    <section className='container mx-auto max-w-screen-lg px-6 mt-16'>
        <div className=''>
          ...
          <img src='../assets/img/mean-stack.jpg' alt='mean stack' className='mx-auto mt-16' />
        </div>
